...
function Reviews() {
  const sources = [
    { name: "Google", icon: <I.Google />, score: "4.9 · 176 reviews" },
  ];
  return (
      ...
      <div className="container">
        <div className="section-head reveal">
          <div>
            ...
            <h2>176 neighbors<br/><em>keep coming back.</em></h2>
          </div>
          <p>
        ...
        <div className="reviews-hero reveal">
          <div className="review-aggregate">
            ...
            <div className="count">Based on 176 verified Google reviews</div>
    ...
    <section className="section about" id="about">
      <div className="container about-grid">
        ...
        <div className="reveal">
          ...
          <h2>Family business,<br/><em>honest work.</em></h2>
          <div className="about-body">
            <p>
              Gary Dominicus built this company on a simple promise: pick up the phone, show up when you say you will, and never charge more than the job is worth. Customers like Joseph have been calling for 13 years. Derek has trusted us for 15. That's not an accident.
            </p>
            <p>
              We're not a franchise. No call centers, no commission-driven upsells. When you call, you speak to someone who knows our plumbers — Deain, Angel, Matt, Nick, Jacob — by name. We send a text when we're on the way and we clean up when we leave.
            </p>
          </div>
          <div className="signature">— Gary Dominicus, Owner</div>
          <div className="about-meta">
            <div><b style={{ color: "var(--ink)" }}>13+</b> · years serving Central NJ</div>
            <div><b style={{ color: "var(--ink)" }}>4.9★</b> · Google rating</div>
            <div><b style={{ color: "var(--ink)" }}>176+</b> · five-star reviews</div>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="section" id="area">
      <div className="container">
        <div className="section-head reveal">
          ...
          <p>
            Based in East Brunswick, we serve Central New Jersey from Old Bridge to Woodbridge. Same fair pricing across the whole map — no fuel surcharges, no zone fees.
          </p>
        </div>
        ...
        <div className="cta-banner reveal">
          <div>
            ...
            <p style={{ marginTop: 16, fontSize: 16, lineHeight: 1.55, opacity: 0.9, maxWidth: 520 }}>
              Same-day service available Mon–Sat, 7 AM–5 PM. Fair pricing, no surprise fees, and a real plumber on the phone when you call.
            </p>
          </div>
