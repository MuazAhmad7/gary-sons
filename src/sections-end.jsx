          ...
          <div className="contact-info reveal">
            <div className="contact-block">
              ...
              <div>
                ...
                <div className="sub">Mon–Sat 7 AM–5 PM. A real person answers.</div>
              </div>
            </div>
            <div className="contact-block">
            ...
            <div className="contact-block">
              ...
              <div>
                ...
                <div className="sub">646 NJ-18 Suite 105D, East Brunswick, NJ 08816</div>
              </div>
            </div>
            <div className="contact-block">
              ...
              <div>
                ...
                <div className="val" style={{ fontSize: 17 }}>Mon–Sat: 7 AM–5 PM<br/>Sunday: Closed</div>
                <div className="sub">Call for urgent needs outside business hours.</div>
              </div>
            </div>
          </div>
        ...
        <div className="footer-grid">
          <div>
            ...
            <p className="footer-blurb">
              Family-owned plumbing &amp; heating in East Brunswick, NJ. Licensed, insured, and trusted by Central NJ families for over 13 years.
            </p>
          ...
          <div>
            ...
            <ul>
              ...
              <li>Mon–Sat: 7 AM–5 PM</li>
              <li>Sunday: Closed</li>
            </ul>
          </div>
        </div>
        <div className="footer-bottom">
          <div>© 2026 Gary Dominicus &amp; Son Plumbing &amp; Heating · NJ Master Plumber #36BI00591200</div>
