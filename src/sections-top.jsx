    ...
    <header className="nav">
      <div className="container nav-inner">
        <a href="#top" className="brand">
          ...
          <div>
            <div className="brand-name">Gary Dominicus &amp; Son</div>
    ...
    <div className={`mobile-sheet ${open ? "open" : ""}`}>
      <div className="head">
        <a href="#top" onClick={onClose} className="brand">
          <div className="brand-mark">GD</div>
          <div><div className="brand-name">Gary Dominicus &amp; Son</div></div>
        </a>
  ...
  return (
    <section className="hero" id="top">
      <div className="container hero-grid">
        <div>
          <span className="eyebrow">East Brunswick, NJ · Family-owned plumbing &amp; heating</span>
          <h1>{renderHeadline(h)}</h1>
          <p className="hero-sub">
            Gary Dominicus &amp; Son has been the trusted plumber for East Brunswick and Central NJ families for over 13 years. We answer the phone, show up on time, and charge what we quote — every time.
          </p>
          ...
          <div className="hero-trust">
            <div className="trust-item">
              ...
              <div>
                ...
                <div style={{ fontSize: 12, marginTop: 2 }}>176+ reviews</div>
              </div>
            </div>
            <div className="trust-item">
              <I.Shield size={20} />
              <div>Licensed · Insured<br/><span style={{ fontSize: 12, opacity: 0.7 }}>#36BI00591200</span></div>
            </div>
            <div className="trust-item">
              <I.Clock size={20} />
              <div>Same-day service<br/><span style={{ fontSize: 12, opacity: 0.7 }}>Mon–Sat 7 AM–5 PM</span></div>
            </div>
          </div>
        </div>
        ...
        <div className="hero-visual">
          ...
          <div className="hero-badge bottom-left">
            ...
            <div>
              <div style={{ fontFamily: "var(--font-display)", fontSize: 18 }}>13+ years trusted</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <div className="why">
          <div className="section-head" style={{ marginBottom: 0 }}>
            <div>
              <span className="eyebrow">Why Gary Dominicus &amp; Son</span>
              <h2>The numbers <em>add up</em>.</h2>
            </div>
            <p>
              No call centers. No commission-driven upsells. Just licensed plumbers, honest pricing, and a family name that East Brunswick neighbors have trusted for over 13 years.
            </p>
          </div>
